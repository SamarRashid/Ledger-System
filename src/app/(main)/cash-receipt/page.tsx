  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-navy text-start">Cash Receipt (گاہک کیش وصولی)</h1>
        </div>
        <div 
        ...
        <div className="flex flex-wrap items-end gap-4" dir="rtl">
          ...
          <div className="flex-1 min-w-[200px]">
            ...
            <div className="flex relative">
              <input 
                ...
                className="w-full p-2 border border-slate-300 rounded-r bg-green-50 font-urdu text-sm focus:outline-none cursor-pointer"
          ...
          <div className="w-40">
            ...
            <input 
              ...
              className="w-full p-2 border border-slate-300 rounded focus:outline-none focus:border-blue-500 bg-blue-50 text-sm font-bold text-left"
              dir="ltr"
            />
          </div>
        ...
        {selectedCustomer && (
          <div className="bg-navy text-white rounded p-4 shadow mt-4">
            <div className="grid grid-cols-3 gap-4" dir="rtl">
              ...
              <div>
                <div className="text-white/70 text-xs mb-1 font-medium">ابھی وصول ہو رہا ہے (Receiving Now)</div>
                <div className="text-xl font-bold text-emerald font-sans" dir="ltr">{received.toLocaleString()} RS</div>
              </div>

              <div>
                <div className="text-white/70 text-xs mb-1 font-medium">باقی بقایا جات (Remaining Balance)</div>
                  ...
                  <tbody className="divide-y divide-slate-200">
                    {recentReceipts.map((r, i) => (
                      <tr key={r.id} className={`hover:bg-blue-50 ${i % 2 === 0 ? 'bg-white' : 'bg-slate-50'}`}>
                        ...
                        <td className="p-2 border-r border-slate-200 font-urdu">{r.description || "کیش وصولی"}</td>
                        <td className="p-2 text-end font-bold text-emerald-600">{r.amount.toLocaleString()}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
